...
const LogementsDetails = ({ logement }) => {
    ...
    const renderStars = () => {
        const stars = [];
        const filledStar = <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const unfilledStar = <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        for (let i = 0; i < 5; i++) {
            if (i < rating) {
                stars.push(<span key={i} className="star filled">{filledStar}</span>);
            } else {
                stars.push(<span key={i} className="star">{unfilledStar}</span>);
            }
        }
        return stars;
    };
            ...
            <div className="logement-details">
                ...
                <div className="logement-host-and-rating">
                    ...
                    <div className="logement-rating">
                        <div className="logement-rating">{renderStars()}</div>
                    </div>
                </div>
            </div>
